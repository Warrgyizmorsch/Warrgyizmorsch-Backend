...
<div class="nxl-content">
    ...
    <x-lead.tools :title="'New Leads Table'" :buckets="$childBuckets" :filterBucket="$childBuckets" :totalLeadsCount="$systemTotalLeadsCount ?? $totalLeadsCount" />

    <div class="main-content px-3 py-2">
        {{-- Main Status Scroll Bar --}}
        <div class="lead-tab-strip">
            <button type="button" class="btn btn-xs btn-light text-muted p-1 rounded-circle" data-status-scroll="prev">
            ...
            <button type="button" class="btn btn-xs btn-light text-muted p-1 rounded-circle" data-status-scroll="next">
