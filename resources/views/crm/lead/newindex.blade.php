...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <x-lead.tools :buckets="$buckets" :totalLeadsCount="$totalLeadsCount" :filteredLeadCount="$filteredLeadCount" :owners="$owners" :sources="$sources" />
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active" id="personal-{{ $lead->id }}" role="tabpanel">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-3 col-sm-6">
                                            <small class="text-muted text-uppercase d-block mb-1" style="font-size: 11px; letter-spacing: 0.5px;">Lead Owner</small>
                                            <span class="fs-15 text-dark">{{ optional($lead->owner)->name ?? 'Unassigned' }}</span>
                                        </div>
                                    </div>
                                </div>
