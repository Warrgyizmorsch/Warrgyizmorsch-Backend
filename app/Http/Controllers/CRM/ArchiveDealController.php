...
class ArchiveDealController extends Controller
{
    public function index(Request $request)
    {
        ...
        $totalLeadsCount = Leads::where('is_archived', 1)->where('is_converted', 1)
        ...
        return view('crm.archive.deals', compact(
            'leads',
            'owners',
            'categories',
            'categorys',
    ...
    public function archive(Request $request, $id)
    {
        ...
        return response()->json([
            'status' => true,
            'message' => 'Deal moved to archive successfully',
        ]);
    }
    ...
    public function bulkArchive(Request $request)
    {
        ...
        return response()->json([
            'status' => true,
            'message' => count($validIds) . ' deal(s) moved to archive successfully',
    ...
    public function bulkRestore(Request $request)
    {
        ...
        return response()->json([
            'status' => true,
            'message' => count($validIds) . ' deal(s) restored successfully',
            'count' => count($validIds),
        ]);
    }
    ...
    public function bulkDelete(Request $request)
    {
        abort_unless(auth()->check(), 401);
        if (auth()->user()->role_id == 3) {
            return response()->json(['status' => false, 'message' => 'Only admins can permanently delete deals'], 403);
        }
        ...
        return response()->json([
            'status' => true,
            'message' => count($ids) . ' deal(s) permanently deleted',
        ]);
    }
}
